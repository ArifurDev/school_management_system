                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                            <div>
                                ...
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Salary Sheets</li>
                                    </ol>
                                </nav>

                                <h4 class="mb-3">Salary Sheets</h4>
                            </div>
                        </div>
                    </div>
                 </div>
                             ...
                             <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center list-action">
                                        <a href="{{ route('salarysheet.edit',$salarysheet->id) }}" class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" ><i class="ri-pencil-line mr-0"></i></a>
                                        <form action="{{ route('salarysheet.destroy',$salarysheet->id) }}" method="POST">
                                            @csrf
                                            @method("DELETE")
